...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            Ssujan Brand
\033[1;37m Facebook:            Ssujan Brand
\033[1;37m Github  :            Sujanbrand-Ssb
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100094704407961')
        pass
    elif select =='F':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100094704407961/')
    else:
